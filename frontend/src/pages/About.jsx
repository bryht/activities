...
export default function About() {
  ...
  return (
    <div className="px-4 py-6 sm:px-6 md:py-10">
      <section className="mx-auto max-w-2xl rounded-2xl bg-gradient-to-b from-brand-100 to-white p-6 text-center shadow-sm ring-1 ring-slate-100 md:p-8">
      ...
      <section className="mt-6 md:mt-10">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          {[
            ...
            <div key={s.title} className="flex gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100 sm:flex-col">
      ...
      <section className="mt-6 md:mt-10">
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {spots.map((s) => (
            <div key={s.id} className="flex items-center justify-between rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-slate-100">
              <div>
      ...
      <p className="mt-8 text-center text-xs text-slate-400 md:mt-12">English · Maastricht 🇳🇱</p>
    </div>
  )
}
